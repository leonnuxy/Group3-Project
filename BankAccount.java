...
public abstract class BankAccount {
  ...
  /* In this class the accountHolder is created as an instance object of Customer and therefore the use of it would only be applied
   * applied to the already created object which cannot be modified or accessed directly in the Customer class but can be initialised. */
  ...
  public void monthEndUpdate() {
    ...
    if (getMonthlyFeesAndInterest() < 0) {
      ...
      balance = a_balance + month_end_value;
    }
  }
}
