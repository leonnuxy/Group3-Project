...
public class Menu extends Application{
	...
	private static String menuBGMFile = "menuBGM.mp3";     
	private static Media menuBGMMedia = new Media(new File(menuBGMFile).toURI().toString());
	static MediaPlayer menuBGMPlayer = new MediaPlayer(menuBGMMedia);
