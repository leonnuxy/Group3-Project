...
public class BankAccountApp extends Application {
	...
	//Instances referencing the Objects in BankAccount through SavingsAccount and ChequingAccount
	...
	static double balance, balz;
	static String accountType = "";
	static String ID = "";
	static String name, cust_name, bal;
	...
	public static void read_file(){
		...
		try {
			...
			//Get rid of this Meant for Tracing.
			...
			//e.printStackTrace();
			System.out.println("Somthing is Wrong: Diagnose");
		}
		catch (Exception e) {
			//e.printStackTrace();
			System.out.println("Somthing is Wrong: Diagnose");
	...
	//Displays the layouts and windows and scenes.
	@Override
	public void start(Stage primaryStage) throws Exception {
		//New account creation: First Screen
	    ...
	    layout3.setVgap(10);
	    layout3.setHgap(5);
	    if (accountType.contains("ChequingAccount")) { balance = chequing.getBalance();}
	    if (accountType.contains("SavingsAccount")) { balance = savings.getBalance();}
	 ...
	 // For the last Screen when file does not exists.
	    ...
	    submit.setOnAction(new EventHandler<ActionEvent>(){
	      ...
	      public void handle(ActionEvent event) {
    	  	...
    	  	if (accountType.contains("ChequingAccount")) { chequing.setCustomer(customer);}
    	    if (accountType.contains("SavingsAccount")) { savings.setCustomer(customer);}
    	    acctType_label = new Label(""+accountType+"");
	    ...
	    // Withdraw button for ChequingAccount & SavingsAccount (Uses layout3)
	...
	// if file does not exist this writes a new file 
	public static void write_file(){
		...
		try {
			...
			if (accountType.contains("ChequingAccount")){
	    	  	bal = Double.toString(chequing.getBalance());
	    	  	file_in.write(bal);
    	    }
    	    if (accountType.contains("SavingsAccount")){
    	    	bal = Double.toString(savings.getBalance());
    		    file_in.write(bal);
    	    }
