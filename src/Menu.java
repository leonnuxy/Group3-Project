...
public class Menu extends Application{
	...
	public void start(Stage primaryStage) {
		...
		/* Set the position of the Score button. */
		...
		/* Add all buttons and label to the initial menu screen */
		menuPane.getChildren().addAll(welcomeCaption,scores,quit,start);
		...
		/* Actions for the Scores Board Button button */
